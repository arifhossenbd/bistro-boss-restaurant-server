...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.6rpgfkx.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    app.post('/users', async(req, res) => {
      const user = req.body;
      //insert email if user doesn exists
